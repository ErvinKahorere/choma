                    ...
                    <div class="row wow fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;">
                        <div class="col-md-12">
                            ...
                            <div class="product-wrapper">
                                ...
                                <!--Product data-->
                                <h2 class="h2-responsive">{{$ourpick->card_product_name}}  | N$ {{$ourpick->card_new_price}}</h2>  
                                ...
                                @if(!Auth::guest())
                                    @if(Auth::user()->id == $ourpick->user_id)
                                        <a href="/ourpicks/{{$ourpick->id}}/edit" class="btn btn-default">Edit</a> 
                                        
                                        {!!Form::open(['action' => ['CardsController@destroy', $ourpick->id], 'method' => 'POST', 'class' => 'pull-right'])!!}
                                ...
                                <hr>
                                <p>{!!$ourpick->card_product_description!!}</p>
